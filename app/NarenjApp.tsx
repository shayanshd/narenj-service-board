...
function ShiftView({ data }: { data: Dashboard }) {
  const [generated, setGenerated] = useState<{ source: "ai" | "fallback"; summary: { headline: string; summary: string; actions: string[] } } | null>(null);
